    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
           @guest
          <div class="li nav-item"><a href="{{ route('register') }}" class="nav-link">Register</a></div>
          <div class="li nav-item"><a href="{{ route('login') }}" class="nav-link">Login</a></div>
          @else
          
          <div class="li nav-item"><a href="{{ route('friends.index') }}" class="nav-link">Amigos</a></div>
          <div class="li nav-item"><a href="{{ route('accept-friendships.index') }}" class="nav-link">Solicitudes</a></div>
